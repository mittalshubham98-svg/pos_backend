...
CATALOG = [
    ...
    dict(item_name="Toor Dal 1 kg", category="Rice & Pulses", brand="Tata Sampann", item_size="1 kg", case_size=30,
         mrp=168, taxable_value=160, total_gst_rate=0, tax_type="Exclusive",
         is_daily_rate_change=True, aisle="A3 · 07", hsn_code="0713"),
    dict(item_name="Iodised Salt 1 kg", category="Sugar & Salt", brand="Tata", item_size="1 kg", case_size=24,
         mrp=28, taxable_value=26, total_gst_rate=5, tax_type="Inclusive_MRP", aisle="C1 · 02",
         hsn_code="2501"),
    dict(item_name="Red Chilli Powder 500 g", category="Spices", brand="Everest", item_size="500 g", case_size=20,
         mrp=148, taxable_value=132, total_gst_rate=5, tax_type="Exclusive",
         promo_status="NEW", aisle="C3 · 04", hsn_code="0904"),
    dict(item_name="Instant Coffee 200 g", category="Beverages", brand="Nescafe", item_size="200 g", case_size=12,
         mrp=495, taxable_value=400, total_gst_rate=18, tax_type="Exclusive", aisle="D1 · 01",
         hsn_code="2101"),
    dict(item_name="Aerated Drink 750 ml", category="Beverages", brand="Coca-Cola", item_size="750 ml", case_size=24,
         mrp=45, taxable_value=35, total_gst_rate=28, tax_type="Inclusive_MRP", aisle="C1 · 04",
         hsn_code="2202"),
    dict(item_name="Dishwash Bar 300 g", category="Cleaning", brand="Vim", item_size="300 g", case_size=30,
         mrp=25, taxable_value=21, total_gst_rate=18, tax_type="Inclusive_MRP", aisle="D2 · 02",
         hsn_code="3401"),
    dict(item_name="Detergent Powder 4 kg", category="Cleaning", brand="Surf Excel", item_size="4 kg", case_size=4,
    ...
    dict(item_name="Hing 50 g", category="Spices", brand="Everest", item_size="50 g", case_size=40,
